...
class TodoStub(object):
    ...
    def __init__(self, channel):
        ...
        self.readTodos = channel.unary_unary(
                '/grpcPackage.Todo/readTodos',
                request_serializer=todo__pb2.voidParam.SerializeToString,
...
def add_TodoServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'readTodos': grpc.unary_unary_rpc_method_handler(
                    servicer.readTodos,
                    request_deserializer=todo__pb2.voidParam.FromString,
...
class Todo(object):
    ...
    def createTodo(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/grpcPackage.Todo/createTodo',
    ...
    def readTodos(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/grpcPackage.Todo/readTodos',
            todo__pb2.voidParam.SerializeToString,
